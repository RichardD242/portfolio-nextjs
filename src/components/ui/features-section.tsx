            ...
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 bg-black/40 backdrop-blur-sm border-white/10">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <h2 className="mt-6 text-center text-3xl font-semibold text-white">Kreativ</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-black/40 backdrop-blur-sm border-white/10">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                                    <Shield className="m-auto h-16 w-16 text-blue-400" strokeWidth={1} />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-lg font-medium text-white">Sicher und Simple</h2>
                                    <p className="text-gray-400">Klare Strukturen und sichere Implementierungen für zuverlässige Anwendungen.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-black/40 backdrop-blur-sm border-white/10">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <svg className="text-gray-400 w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium text-white">Schneller als Licht</h2>
                                    <p className="text-gray-400">Optimierte Performance und blitzschnelle Ladezeiten für beste Nutzererfahrung.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-black/40 backdrop-blur-sm border-white/10">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                                        <Lightbulb className="m-auto size-5 text-yellow-400" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-white">Innovative Lösungen</h2>
                                        <p className="text-gray-400">Kreative Ansätze und moderne Technologien für einzigartige Projekte.</p>
                                    </div>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-black/40 backdrop-blur-sm border-white/10">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                                        <Users className="m-auto size-6 text-green-400" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-white">Im Team arbeiten</h2>
                                        <p className="text-gray-400">Effektive Zusammenarbeit und klare Kommunikation für erfolgreiche Projekte.</p>
                                    </div>
                                </div>
                                <div className="before:bg-white/10 relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-white/10 bg-black/40 px-2 py-1 text-xs text-white shadow-sm">Designer</span>
                                            <div className="ring-black size-7 ring-4">
                                                <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop&crop=face" alt="Team member" />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-black size-8 ring-4">
                                                <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face" alt="Team member" />
                                            </div>
                                            <span className="block h-fit rounded border border-white/10 bg-black/40 px-2 py-1 text-xs text-white shadow-sm">Developer</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-white/10 bg-black/40 px-2 py-1 text-xs text-white shadow-sm">Manager</span>
                                            <div className="ring-black size-7 ring-4">
                                                <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face" alt="Team member" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
